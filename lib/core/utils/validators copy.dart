class Validators {
  ...
  /// Validates the opening load amount on a new provider.
  ///
  /// Zero is allowed here — a provider can be created empty and
  /// topped up later.
  ...
  /// charging for that service — pass [required] accordingly.
