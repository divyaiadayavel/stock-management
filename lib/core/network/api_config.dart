...
static const String localBaseUrl =
  ...
  static const String staffLogin =
      '$baseUrl/api/auth/staff_login.php';

  static const String validateSession =
      '$baseUrl/api/auth/validate_session.php';

  static const String staffLogout =
      '$baseUrl/api/auth/staff_logout.php';

  static const String sendOtp =
      '$baseUrl/api/auth/send_otp.php';

  static const String verifyOtp =
      '$baseUrl/api/auth/verify_otp.php';

  static const String resetPassword =
      '$baseUrl/api/auth/reset_password.php';
  ...
  static const String getSettings =
      '$baseUrl/api/settings/get_settings.php';

  static const String saveSettings =
      '$baseUrl/api/settings/save_settings.php';
  ...
  static const String getStaff =
      '$baseUrl/api/staff/get_staff.php';

  static const String saveStaff =
      '$baseUrl/api/staff/save_staff.php';

  static const String deleteStaff =
      '$baseUrl/api/staff/delete_staff.php';

  static const String updateStatus =
      '$baseUrl/api/staff/update_status.php';
  ...
  static const String getProducts =
      '$baseUrl/api/products/products.php';
  ...
  static const String uploadImage =
      '$baseUrl/api/products/upload_image.php';
  ...
  static const String getSuppliers =
      '$baseUrl/api/suppliers/suppliers.php';
  ...
  static const String getCustomers =
      '$baseUrl/api/customers/customers.php';
  ...
  static const String createSale =
      '$baseUrl/api/sales/create_sale.php';

  static const String getInvoice =
      '$baseUrl/api/sales/get_invoice.php';

  static const String addPayment =
      '$baseUrl/api/sales/add_payment.php';
  ...
  static const String inventory =
      '$baseUrl/api/inventory/inventory.php';

  static const String purchases =
      '$baseUrl/api/purchases/purchases.php';
  ...
  static const String reports =
      '$baseUrl/api/reports/reports.php';
  ...
  static const String dashboard =
      '$baseUrl/api/dashboard/dashboard.php';
  ...
  static const String saveService =
      '$baseUrl/api/services/admin/services.php';
  ...
  static const String expenses =
      '$baseUrl/api/expenses/expense.php';
