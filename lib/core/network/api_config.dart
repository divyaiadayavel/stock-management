...
class ApiConfig {
  ...
  static const String purchases = '$baseUrl/api/purchases/purchases.php'; // 🟢 Added Purchases Route
...
static const String dashboard =
  ...
  // ── Backup ──────────────────────────────────────────────────
static const String getBackupStatus   = '$baseUrl/api/backup/backup.php?action=status';
static const String createBackup      = '$baseUrl/api/backup/backup.php?action=create';
static const String completeBackup    = '$baseUrl/api/backup/backup.php?action=complete';
static const String getBackupHistory  = '$baseUrl/api/backup/backup.php?action=history';
static const String restoreBackup     = '$baseUrl/api/backup/backup.php?action=restore';
static const String saveBackupSettings = '$baseUrl/api/backup/backup.php?action=saveSettings';
