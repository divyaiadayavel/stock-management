// lib/features/services/presentation/widgets/service_list_tile.dart
    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: Row(
          children: [
            Container(
              width: R.imgSize(context, 0.11),
              height: R.imgSize(context, 0.11),
              decoration: BoxDecoration(
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    '${service.questions.length} Fields to complete',
                    style: TextStyle(
