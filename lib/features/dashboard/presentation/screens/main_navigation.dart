...
class _MainNavigationScreenState extends ConsumerState<MainNavigationScreen> {
  ...
  static const List<(AppFeature, Widget)> _pages = [
    (AppFeature.dashboard,  AccessGuard(feature: AppFeature.dashboard,  child: DashboardScreen())),
    (AppFeature.products,   AccessGuard(feature: AppFeature.products,   child: ProductScreen())),
    (AppFeature.suppliers,  AccessGuard(feature: AppFeature.suppliers,  child: SuppliersScreen())),
    (AppFeature.settings,   AccessGuard(feature: AppFeature.settings,   child: SettingsScreen())),
  ];
